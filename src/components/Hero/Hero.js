      ...
      <div className="hero ">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className="md:px-10">
            ...
            <h1 className="text-5xl font-extrabold mt-6 text-secondary leading-snug  ">Your New <span className="text-primary">Smile</span> Starts Here</h1>
            <p className="py-6 text-secondary  font-light">
            ...
            <button className=" btn-warning text-white px-12 rounded-lg text-lg tracking-wider font-bold py-4">Read More</button>
          </div>
        </div>
      </div>
    </div>
