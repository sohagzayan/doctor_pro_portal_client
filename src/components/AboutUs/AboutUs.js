...
import aboutUsImg from "../../assets/images/pic-1.ad1ed7ee.jpg";
import aboutUsImg2 from "../../assets/images/pic-2.0593bc2f.jpg";
import aboutUsImg3 from "../../assets/images/pic-3.fa689b10.jpg";
const AboutUs = () => {
  return (
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
        <div className="grid grid-cols-2  p-4">
          ...
          <div
            ...
            className="flex w-full p-3 flex-col text-secondary font-bold items-center Yearn20Experience  justify-center bg-info "
          >
            <span className=" text-6xl md:text-8xl text-primary font-extrabold">
              20
            </span>
            Year Experience
          </div>
        ...
        <div className="p-4">
          <span
            className="px-4 py-1 text-warning rounded-md mb-4 inline-block font-bold text-xl"
            style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-6">
            <div className="flex items-center justify-between pr-3 border-2 border-[#b2f0fb]  font-bold text-secondary text-lg  rounded-lg">
              <span
                style={{ borderRadius: "0 30px 30px 0" }}
                className="bg-[#b2f0fb7c] p-2  "
              >
                <svg
            ...
            <div className="flex items-center pr-3 justify-between border-2 border-[#b2f0fb]  font-bold text-secondary text-lg  rounded-lg">
              <span
                style={{ borderRadius: "0 30px 30px 0" }}
                className="bg-[#b2f0fb7c] p-2"
              >
            ...
            <div className="flex items-center  pr-3 justify-between border-2 border-[#ffbdbc]  font-bold text-secondary text-lg  rounded-lg">
              <span
                style={{ borderRadius: "0 30px 30px 0" }}
                className="bg-[#ffbdbc8c] p-2"
              >
                <svg
                  enable-background="new 0 0 512 512"
                  height="50"
          ...
          <button className="bg-primary shadow-xl shadow-[rgba(86,90,207,.3)] text-white px-8 py-2 rounded-md font-bold mt-5">
            Read More
          </button>
        </div>
      </div>
